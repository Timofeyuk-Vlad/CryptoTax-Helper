...
Приложение имеет адаптивный веб-интерфейс, оптимизированный для мобильных устройств.

### Главный экран с обзором портфеля и налогов
![Дашборд приложения](./mockups/dashboard-mockup.png)

### Экран подключения к криптобиржам через API
![Подключение к биржам](./mockups/api-connection.png)

### Экран генерации налоговых отчетов для РФ и РБ
![Генерация отчетов](./mockups/report-generation.png)

### Экран настройки налогового профиля с выбором страны
![Настройка профиля](./mockups/tax-profile-setup.png)

### Экран истории транзакций с возможностью редактирования
