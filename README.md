...
### Главный экран с обзором портфеля
![Дашборд приложения](./docs/mockups/dashboard-mockup.png)

### Подключение к криптобиржам  
![Настройка API подключений](./docs/mockups/api-connection.png)

### Генерация налоговых отчетов
![Создание отчетов для ФНС и РБ](./docs/mockups/report-generation.png)

### Настройка налогового профиля
![Выбор страны резидентства](./docs/mockups/tax-profile-setup.png)

### История всех транзакций
![Просмотр и редактирование операций](./docs/mockups/transaction-history.png)
...
Проект разрабатывается в рамках учебного задания по курсу **"Разработка и документирование требований к учебному проекту"** и предназначен для образовательных целей.
